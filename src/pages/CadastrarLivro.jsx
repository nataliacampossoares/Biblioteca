        ...
        <label className="flex flex-col">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              {autores
                .filter((autor) => autor.nome_autor && isNaN(autor.nome_autor))
                .map((autor) => (
            ...
            <button type="button" className="border border-red-500 text-red-500 rounded px-2 py-1 text-sm" onClick={() => setMostrarCadastroAutor(!mostrarCadastroAutor)}>
          ...
          {mostrarCadastroAutor && (
            <div className="bg-gray-200 p-3 rounded mt-2">
              ...
              />
              <button type="button" className="bg-red-500 text-white px-4 py-1 rounded" onClick={() => cadastrar("autor", novoAutor)}>
                Salvar
              </button>
            </div>
          )}
        ...
        <label className="flex flex-col">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              {categorias
                .filter((c) => c.nome_categoria && isNaN(c.nome_categoria))
                .map((c) => (
            ...
            <button type="button" className="border border-red-500 text-red-500 rounded px-2 py-1 text-sm" onClick={() => setMostrarCadastroCategoria(!mostrarCadastroCategoria)}>
        ...
        <label className="flex flex-col">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              {subcategorias
                .filter((s) => s.nome_categoria && isNaN(s.nome_categoria))
                .map((s) => (
            ...
            <button type="button" className="border border-red-500 text-red-500 rounded px-2 py-1 text-sm" onClick={() => setMostrarCadastroSubcategoria(!mostrarCadastroSubcategoria)}>
        ...
        <label className="flex flex-col">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              {editoras
                .filter((e) => e.nome_editora && isNaN(e.nome_editora))
                .map((e) => (
            ...
            <button type="button" className="border border-red-500 text-red-500 rounded px-2 py-1 text-sm" onClick={() => setMostrarCadastroEditora(!mostrarCadastroEditora)}>
